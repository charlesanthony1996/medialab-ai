...
loaded_model = AutoModelForSequenceClassification.from_pretrained("cardiffnlp/twitter-roberta-base-hate")
...
def process_text(text, threshold=0.4):
    # Preprocess the text
    ...
    negativity_score = scores[0][1]  # Assuming binary classification
